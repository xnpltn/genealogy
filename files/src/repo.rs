...
pub async fn get_all_employees(
    ...
    let employees: Rc<VecModel<slint::ModelRc<StandardListViewItem>>> =
    ...
    for row in rows {
        ...
        let state: String = row.try_get("state").unwrap_or("".to_string());
